...
====
$ all-repos-sed 's/min_ansible_version: ".*"/min_ansible_version: "2.11"/g' 'meta/main.yml' --commit-msg "chore: set min_ansible_version to 2.11 as per JonasPammer/cookiecutter-ansible-roles"
====
